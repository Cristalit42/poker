...
document.addEventListener('DOMContentLoaded', ()=>{
    (0, $9970b34361e607e2$export$cb45b08d97cdc4fd).bind('[data-fancybox="video-gallery"]', {
        Video: {}
    });
    ...
    const burgerOpen = document.querySelector('.js-burger__open');
    const burgerClose = document.querySelector('.js-burger__close');
